...
<%--                            </div>--%>
                            ...
                            <div class="d-flex flex-column">
                                <a href="../../demo14/dist/apps/user-management/users/view.html" class="text-gray-800 text-hover-primary mb-1">Emma Smith</a>
                        ...
                        <!--end::Two step=-->
                        <!--begin::Joined-->
                        <td><span class="badge badge-primary badge-lg">Primary</span></td>
                        <!--begin::Joined-->
                        <!--begin::Action=-->
                        <td class="text-end">
