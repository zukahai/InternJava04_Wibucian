...
<c:set var="user">
	<security:authentication property="principal.employee" />
</c:set>
...
<c:choose>
	...
	<c:otherwise>
		<c:set var="username">
			<security:authentication property="principal.employee.name" />
		</c:set>
		<c:set var="role" value="STAFF"/>
		<c:set var="email">
			<security:authentication property="principal.employee.email" />
		</c:set>
	</c:otherwise>
</c:choose>
						...
						<div class="d-flex align-items-center flex-shrink-0">
							...
							<div class="d-flex align-items-center ms-1"
								...
								>
									...
									>
                                    <span class="text-muted fs-8 fw-semibold lh-1 mb-2">
                                        ${username}
                                    </span>
										<span class="text-white fs-8 fw-bold lh-1">${role}</span>
									</div>
									<!--end::Name-->
									<!--begin::Symbol-->
									<div class="symbol symbol-30px symbol-md-40px">
										<img src="/admin/assets/media/avatars/300-1.jpg"
											 alt="image"/>
									</div>
									<!--end::Symbol-->
								</div>
