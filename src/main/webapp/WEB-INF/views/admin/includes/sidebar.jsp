        ...
        >
            ...
            <div data-kt-menu-trigger="click" class="menu-item here menu-accordion">
                ...
                <span class="menu-link">
                    ...
                    <span class="menu-title">Quản lí quán cà phê</span>
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        ...
                        >
                            ...
                            <span class="menu-title">Xem danh sách sản phẩm</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
...
<%--                                                    <!--end::Svg Icon-->--%>
<%--                                                </span>--%>
<%--                                                <span class="menu-title">Quản lí nhập hàng</span>--%>
<%--                                                <span class="menu-arrow"></span>--%>
<%--                                            </span>--%>
<%--                <!--end:Menu link-->--%>
<%--                <!--begin:Menu sub-->--%>
...
<%--                                                            <span class="bullet bullet-dot"></span>--%>
<%--                                                        </span>--%>
<%--                            <span class="menu-title">Thêm nhập hàng</span>--%>
<%--                        </a>--%>
<%--                        <!--end:Menu link-->--%>
<%--                    </div>--%>
<%--                    <!--end:Menu item-->--%>
                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        ...
                        >
                            ...
                            <span class="menu-title">Thêm nguyên liệu trong ngày</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
