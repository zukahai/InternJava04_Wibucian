    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-body p-9">
            <form action="/admin/ingredient/edit" method="post">
                ...
                <div class="form-floating my-5">
                    <input type="date" class="form-control" id="expiryIngredient" name="expiryIngredient" value="${xemdanhsach.expiryIngredient}"/>
                    <label for="expiryIngredient">Hạn sử dụng</label>
                </div>
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="price" name="price" value="${xemdanhsach.price}"/>
                    <label for="price">Giá</label>
                </div>
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="origin" name="origin" value="${xemdanhsach.origin}"/>
                    <label for="origin">Nguồn gốc</label>
                </div>
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="unit" name="unit" value="${xemdanhsach.unit}"/>
