...
<div class="d-flex flex-column flex-root">
    <!--begin::Page bg image-->
    <style>body { background-image: url('/admin/assets/img/cafe.png'); } [data-theme="dark"] body { background-image: url('/admin/assets/img/cafe.png'); }</style>
    <!--end::Page bg image-->
                ...
                <div class="card-body p-10 p-lg-20">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo14/dist/index.html" action="#">
                        ...
                        <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                            <div></div>
                            <!--begin::Link-->
                            <a href="../../demo14/dist/authentication/layouts/creative/reset-password.html" class="link-primary">Forgot Password ?</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Submit button-->
