    ...
    <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
        ...
        <div class="card-body p-9">
            ...
            <div class="rounded border p-5">
                ...
                <div class="form-floating my-5">
                    <select class="form-select" data-control="select2" id="idTypeProduct" name="idProductType" data-placeholder="Select an option">
                ...
                <div class="form-floating my-5">
                    <input type="text" class="form-control" id="describe" name="describe" placeholder="VIP"/>
